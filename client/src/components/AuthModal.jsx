...
export default function AuthModal({ isOpen, onClose, onAuthSuccess }) {
  ...
  // Initialize official Google Identity Services in Modal
  useEffect(() => {
    if (!isOpen) return;
    ...
    const initGoogleIdentity = () => {
      ...
      try {
        ...
        console.warn('Google GSI modal init notice:', err);
      }
    };
  ...
  // Handle verified Google OAuth Credential
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl border border-slate-100 relative max-h-[94vh] overflow-y-auto">
        ...
        <div className="mb-5 flex flex-col items-center justify-center">
          ...
          />
          {!googleReady && (
            <div className="w-full py-2 px-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-500 text-xs flex items-center justify-center gap-2">
