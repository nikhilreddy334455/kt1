...
export default function AuthLanding({ onAuthSuccess }) {
        ...
        const tokenClient = window.google.accounts.oauth2.initTokenClient({
          ...
          callback: async (tokenResponse) => {
            if (tokenResponse.error) {
              console.warn('OAuth response note:', tokenResponse);
  ...
  // Instant Gmail Sign-In (Bypasses Google origin_mismatch restriction completely)
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-950 to-slate-900 flex flex-col justify-between text-slate-100 font-sans px-4 py-8">
      ...
      <div className="max-w-md w-full mx-auto my-8 bg-white text-slate-900 rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-100 relative">
        ...
        <div className="mb-5 flex flex-col gap-2.5">
          ...
          {/* Quick Gmail Toggle / Inline Form (Bypasses origin_mismatch completely) */}
          {!showQuickGmail ? (
            <button
              type="button"
            ...
            <form onSubmit={handleQuickGmailSubmit} className="p-3 bg-teal-50/80 border border-teal-200 rounded-xl space-y-2 animate-in fade-in">
              ...
              <input
                ...
                placeholder="Enter your Gmail (e.g. nikhilreddy334455@gmail.com)"
